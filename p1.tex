...
Esta función eliminará una cuenta de usuario del sistema (RD \ref{rdd:\ref{rdd:eliminar-usuario}}, para ello son necesarios los datos (RD \ref{rdd:inicio-sesion}).
