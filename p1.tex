...
\item Identificador de canción (Cadena de 16 caracteres númericos)
...
\rsu{Restricciones al añadir una canción}
\begin{itemize}
\item El autor y género deben estar registrados previamente en el sistema (RD \ref{rdu:datos-nueva-cancion}, RF \ref{rfu:añadir-cancion})
\end{itemize}
\refstepcounter{RS}
...
\begin{itemize}
\item Es necesario haber escuchado una canción para añadir un comentario. (RD \ref{rdt:escuchadas-man}, RF \ref{rft:comentar})\label{rst:comentar}
\end{itemize}

\rst{Restricciones para añadir una canción a favoritos}
\begin{itemize}
\item Es necesario haber escuchado una canción para añadirla a favoritos. (RD \ref{rdt:favoritas-man}, RF \ref{rft:favorita})\label{rst:favorita}
\end{itemize}

\rst{Restricciones para añadir una valoración}
\begin{itemize}
\item Es necesario haber escuchado una canción para añadir una valoración (RD \ref{rdt:valoracion-man}, RF\ref{rft:valorar})\label{rst:valorar}
\end{itemize}
...
\begin{itemize}
\item Es necesario haber escuchado alguna canción o haber seguido a algún usuario que haya escuchado alguna canción (RD \ref{rdt:escuchadas-man}, RF \ref{rfc:sugerir}).
\end{itemize}
