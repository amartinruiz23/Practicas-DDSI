...
\rdd{Datos almacenados al modificar un dato de una canción\label{rdu:datos-almacenados-modificar-cancion}}
\begin{itemize}
\item Dato modificado (En el formato correspondiente al dato)
\end{itemize}

\rdd{Datos eliminados al eliminar una canción \label{rdu:datos-almacenados-eliminar-cancion}}
\begin{itemize}
  \item Título (Una cadena no vacía de hasta 50 caracteres)
  \item Fecha (8 números en formado dd/mm/aaaa)
  \item Autor (Identificador del autor)
...
\rdd{Datos almacenados al modificar un dato de un género\label{rdu:datos-almacenados-modificar-genero}}
\begin{itemize}
\item Dato modificado (En el formato correspondiente al dato)
\end{itemize}

\rdd{Datos eliminados al eliminar un género \label{rdu:datos-almacenados-eliminar-genero}}
\begin{itemize}
  \item Nombre (Cadena de hasta 20 caracteres)
  \item Descripción (Cadena de hasta 500 caracteres)
\end{itemize}

\rdd{Datos almacenados al modificar un dato de un autor\label{rdu:datos-almacenados-modificar-autor}}
\begin{itemize}
\item Dato modificado (En el formato correspondiente al dato)
\end{itemize}

\rdd{Datos eliminados al eliminar un autor \label{rdu:datos-almacenados-eliminar-autor}}
\begin{itemize}
  \item Nombre (Cadena de hasta 30 caracteres)
  \item Procedencia (opcional) (Dos listas de 20 caracteres alfanuméricos)
  \item Intervalo de actividad (opcional) (Dos fechas en el formato dd/mm/aaaa, siendo la segunda sustituible por `actualidad') (opcional)
