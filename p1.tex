...
\item Nuevo dato
\end{itemize}
\rdd{Datos eliminados ante la modificacion de un dato personal\label{rdd:eliminar-dato-almacenados}}
\begin{itemize}
\item Dato antiguo.
\end{itemize}
...
RD \ref{rdd:registro-usuario-almacenados}

\rfd{Inicio de sesión\label{rfd:inicio-sesion}}
Para iniciar sesión el usuario deberá proporcionar los siguientes datos: RD \ref{rdd:inicio-sesion}
...
RD \ref{rdd:modificar-dato}.
El sistema almacenará los datos
RD \ref{rdd:modificar-dato-almacenados}
y eliminará RD \ref{rdd:eliminar-dato-almacenados}

\rfd{Dar baja}
Para dar de baja una cuenta en el sistema será necesario haber accedido a él. Se eliminaran los siguientes datos del sistema: RD \ref{rdd:eliminar-usuario}
